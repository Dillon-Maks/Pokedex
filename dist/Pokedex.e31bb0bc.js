...
function makeCard(pokemon) {
  ...
  var movesUL = document.createElement('ol'); // Add all the classes

  card.classList.add('card'); // "Hydrate" elements
  ...
  moves.forEach(function (move) {
    var moveText = document.createElement('li');
...
function getPokemon(pokemon) {
  _axios.default.get("https://pokeapi.co/api/v2/pokemon/".concat(pokemon.toLowerCase())).then(function (resp) {
    console.log(resp);
    var newPokemon = makeCard(resp.data);
...
//# sourceMappingURL=/Pokedex.e31bb0bc.js.map